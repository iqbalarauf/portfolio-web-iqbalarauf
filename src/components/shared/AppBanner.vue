	...
	<section class="flex flex-col sm:justify-between items-center sm:flex-row mt-12 sm:mt-10">
		...
		<div class="w-full md:w-1/3 text-left">
			...
			<p
				...
				Software QA, UI/UX Designer, and Mobile Dev. Also Content Writer.
			</p>
			<div class="flex justify-center sm:block">
				<a download="Resume-IqbalARauf.pdf" href="/files/Resume-IqbalARauf.pdf"
					...
					<span class="text-sm sm:text-lg font-general-medium duration-100">Unduh CV</span></a>
			</div>
		</div>
